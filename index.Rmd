...
##Day 2: The Actor-Partner Interdependence Model
  ...
  + Lecture and Lab 1:15-3:30
    ...
    - Actor-Partner Interactions: [Slides](Actor Partner Interactions.pdf) and [Example](Actor-Partner Interactions.html)
...
##Day 5: Additional Topics
  ...
  + Lecture 9-12
    ...
    - Alternative Dyadic Models
      ...
      - [Generalized Linear Mixed Models](Genderalized_Linear_Mixed_Models___GEE.html)
      - [Generalized Estimating Equations (GEE)](Genderalized_Linear_Mixed_Models___GEE.html)
